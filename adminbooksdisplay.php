...
<body>
    <nav class="navbar background">
        ...
        <ul class="nav-list">
          <!--<div class="logo">
            ...
            -->
            <li><a href="adminbooksadd.php">Add     
            </a></li>
            <li><a href="all admin.html">Back      
            </a></li>
            <li><a href="adminbooksdelete.php">Delete</a></li>   
        </ul>
 </nav>
    <section class="firstsection">
        <div class="box-main" style="width:70%;height:100%;">
           ...
           echo "<tr>"; 
           echo "<th> ID </th> <th> Name</th><th> AUTHOR </th><th> TYPE</th><th> PRICE</th><th>  COLOR</th><th> MATERIAL </th><th> STOCK_QUANTITY </th><th> ISSUE_DATE </th>"; 
           echo "</tr>"; 
