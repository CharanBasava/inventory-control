...
$query="insert into drinks(id,name,brand,type,price,color,material,stock_quantity,warranty)values('$id','$name','$brand','$type','$price','$color','$material','$stock_quantity','$warranty')"; 
