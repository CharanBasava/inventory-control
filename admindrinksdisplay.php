    ...
    <nav class="navbar background">
        ...
        <ul class="nav-list">
          <!--<div class="logo">
            ...
            -->
            <li><a href="admindrinksadd.php">Add     
            </a></li>
            <li><a href="all admin.html">Back      
            </a></li>
            <li><a href="admindrinksdelete.php">Delete</a></li>   
        </ul>
 </nav>
    <section class="firstsection">
        <div class="box-main" style="width:70%;height:100%;">
            <div class="firstHalf">  
           <h1 align="center">Drinks details</h1> 
           <br>
           <?php 
           ...
           echo "<tr>"; 
           echo "<th> ID </th> <th> Name</th><th> BRAND </th><th> FLAVOUR</th><th> PRICE</th><th>  COLOR</th><th> MATERIAL </th><th> STOCK_QUANTITY </th><th> ISSUE_DATE </th>"; 
           echo "</tr>"; 
