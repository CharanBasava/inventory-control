...
$query="insert into watch(id,name,brand,type,price,color,material,stock_quantity,warranty)values('$id','$name','$brand','$type','$price','$color','$material','$stock_quantity','$warranty')"; 
